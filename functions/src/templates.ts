...
function memberSessionReminder24h(data: TemplateData): RenderedMessage {
...
function memberSessionStartingSoon(data: TemplateData): RenderedMessage {
  const firstName = data.memberName.split(' ')[0] || 'there';
  const sessionLabel = formatSessionType(data.sessionType);
...
function coachSessionReminder24h(data: TemplateData): RenderedMessage {
...
function coachSessionStartingSoon(data: TemplateData): RenderedMessage {
  const coachFirst = data.coachName.split(' ')[0] || 'Coach';
  const sessionLabel = formatSessionType(data.sessionType);
...
function missedSessionFollowup(data: TemplateData): RenderedMessage {
  const firstName = data.memberName.split(' ')[0] || 'there';
  const sessionLabel = formatSessionType(data.sessionType);
...
function recordingReady(data: TemplateData): RenderedMessage {
  const firstName = data.memberName.split(' ')[0] || 'there';
  const sessionLabel = formatSessionType(data.sessionType);
...
export function adminLeadAlertEmail(
  leadName: string,
  leadEmail: string,
  leadPhone: string,
  goals: string
