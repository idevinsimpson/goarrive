...
|---|---|---|
| 1 | Playbook polish + settings completeness | The full scheduling/booking/live-view loop is now in production. Next: three-dot settings menu (#216), close stale #203 and #204, then surface playbook analytics and coach-to-member comms within the session. |
