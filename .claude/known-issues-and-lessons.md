...
Staging seed scripts and setup guides accumulated plaintext passwords and service-account snippets in committed docs files. These were removed (commit `8ae995e`). Lesson: docs in the repo are public — never include passwords, API keys, or service-account JSON snippets in any `.md` or doc file; reference environment variables or Secret Manager paths instead.
