...
| **Cloud Functions** | Backend logic and integrations. | All heavy lifting, third-party integrations (Stripe, Zoom, OpenAI), and admin operations are handled by Firebase Cloud Functions Gen 2. |
