...
1. If `$ARGUMENTS` is empty, list `personas/*.json` and ask who they want.
2. Slugify the name. If `personas/<slug>.json` exists, load it — do not re-research.
...
5. Write the slug to `personas/.active`.
