...
| **E3.5** | Phone-test fixes: signed-in home and routing (no setup screens on every sign-in), profile merge, 18+ gate removed (Devin 2026-09-06), terms readable inline, human labels, `public` join policy exposed with an invite link, in-app-browser hint; turn B: places-first types, place label, link-joinable `inviteOnly`, QR | M-U2 correction + M-U5 start | Maia — **turn A dispatched 2026-09-06 01:3xZ**; spec `dispatch/E3.5-PHONE-TEST-FIXES.md`; decisions pending Devin: age floor, legal text, join-policy semantics, E4 sequencing vs the FitLife reduction |
