...
| `apps/goarrive/assets/coach-discovery/member-maya-home.png` | Documentary photo, relatable Latina woman in her late 30s preparing to train in a lived-in living room/home gym; natural body and equipment, calm determination, warm practical light plus blue window light; no glamour, commercial gym, text, branding, or aggressive pose. | **Lossless generated source.** Runtime uses the matching WebP. Scene 8 discloses that Maya is not a real member testimonial. |
