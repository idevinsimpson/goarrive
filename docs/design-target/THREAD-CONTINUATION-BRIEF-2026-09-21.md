...
`0e58f41` HOLDS (`5785825795`, pointer `5785827678`) — the Director's final
reporter acceptance is the last gate before the owner's merge decision. Final Join acceptance and the accepted-AFTER
