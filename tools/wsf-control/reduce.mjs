 ...
 * for the first), and `seq` counts from 1, so a removed, reordered, edited or
 * concurrently appended line breaks the chain and the whole ledger is refused.
 */
...
/** Reduce ledger text to a state, verifying every line's shape, chain and legality. */
