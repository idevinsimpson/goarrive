...
const ICONS: Record<string, IconDef> = {
  ...
  sparkle: {
    paths: [],
    fill: [
      'M12 3l2.1 5.4L19.5 10.5l-5.4 2.1L12 18l-2.1-5.4L4.5 10.5l5.4-2.1L12 3z',
  ...
  // ── New icons for workout overlay ──
  'hourglass': {
    paths: [
      'M6 2h12',
      'M6 22h12',
      'M7 2v4a6 6 0 005 5.91',
      'M17 2v4a6 6 0 01-5 5.91',
      'M7 22v-4a6 6 0 015-5.91',
      'M17 22v-4a6 6 0 00-5-5.91',
    ],
  },
  'flame': {
    paths: [],
    fill: [
      'M12 22c4.97 0 8-3.58 8-8 0-3.07-2.27-6.64-4-8.18C14.5 4.32 13 2 12 2c-1 0-2.5 2.32-4 3.82C6.27 7.36 4 10.93 4 14c0 4.42 3.03 8 8 8zm0-4a3 3 0 01-3-3c0-1.5 1-3 3-5 2 2 3 3.5 3 5a3 3 0 01-3 3z',
    ],
  },
  'dumbbell': {
    paths: [
    ...
    fill: [
      'M2 9a2 2 0 014 0v6a2 2 0 01-4 0V9z',
      'M18 9a2 2 0 014 0v6a2 2 0 01-4 0V9z',
      'M5 10h2v4H5zM17 10h2v4h-2z',
      'M7 11h10v2H7z',
    ],
  },
  'more-horizontal': {
