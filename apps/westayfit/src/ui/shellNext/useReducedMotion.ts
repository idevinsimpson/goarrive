...
/**
 * REDUCED MOTION, ASKED OF THE PLATFORM RATHER THAN ASSUMED. PROTOTYPE ONLY.
 *
 ...
 *
 * The prototype uses it to turn the MOVE sheet's slide OFF rather than to
 * pick a gentler slide. A member who has asked for less motion has asked for
