...
export default function PrivacySettingsScreen() {
  ...
  return (
    <View style={st.screen} testID="wsf-privacy-screen">
      <View style={st.head}>
      ...
      {/* COMMUNITY-SETTINGS-PARITY-1: the same panel the Settings panel draws
          (W4's CommunityPrivacyPanelView through src/ui/CommunityPrivacyControls.tsx),
          including W7 Check 43's failure behaviour. It scrolls itself. */}
      <View style={st.fill}>
...
const st = StyleSheet.create({
  ...
  head: { paddingHorizontal: 20, paddingTop: 14, gap: 12 },
  fill: { flex: 1, paddingBottom: MEMBER_TAB_BAR_BODY },
