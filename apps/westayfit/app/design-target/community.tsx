...
const FRAMES: Frame[] = [
  ...
  {
    id: 'list-severalnocurrent-390x844',
    label: 'Community list · several, none chosen yet · 390×844',
    width: P.w,
    height: P.h,
    node: <CommunityListTarget state="severalNoCurrent" />,
  },
  {
    id: 'list-severalnocurrent-390x640',
    label: 'Community list · several, none chosen yet · 390×640',
    width: SHORT.w,
    height: SHORT.h,
    node: <CommunityListTarget state="severalNoCurrent" />,
  },
  {
    id: 'list-one-390x640',
    label: 'Community list · one membership · 390×640',
    width: SHORT.w,
    height: SHORT.h,
    node: <CommunityListTarget state="one" />,
  },
  {
    id: 'list-none-390x640',
    label: 'Community list · no memberships · 390×640',
    width: SHORT.w,
    height: SHORT.h,
